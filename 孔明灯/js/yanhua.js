...
// var canvas = document.getElementById("yanhua-canvas")
    ...
    function mouseDownHandler(e) {
     ...
     // debugger
      ...
      if (remianAllSeconds >= 0) {
        ...
        createFireworks(x, y, ['生日快乐，漫天灯火为你而明！'][Math.floor(Math.random() * 1)]);
      }
      
      // 如果不延时的话则太快，烟花根本显示不出来
      setTimeout(function(){
        $("#container").fadeToggle(500); // 500ms 动画时间
      }, 850);
...
//          });
    ...
    document.getElementById("btn_yanhua").addEventListener("click", mouseDownHandler);
